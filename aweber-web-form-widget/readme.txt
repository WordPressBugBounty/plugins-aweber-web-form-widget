...
== Changelog =
= 7.3.34 =
* Fix Site URL display in System Info tab
* Add warning when WordPress URL configuration does not match the current domain

= 7.3.33 =
* Fix OAuth2 token persistence

= 7.3.32 =
* Updated 'Tested up to' to 6.9

= 7.3.31 =
* Verify the object exists before calling it
...
= 7.3.21 =
* Fixes multiple security issues raised by plugin-check.
